                ...
                {showSearch && (
                    <div className="relative hidden lg:block">
                        ...
                        <Input
                            ...
                            className="w-80 pl-11 h-10 bg-slate-50 border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-teal-500/20 transition-smooth shadow-sm"
                        />
                    </div>
                )}
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-3 pl-3 ml-2 border-l border-slate-200">
                        <div className="text-right hidden sm:block">
                            <p className="text-sm font-semibold text-slate-900 leading-none">City General Hospital</p>
                            <p className="text-[10px] text-teal-600 font-bold uppercase tracking-wider mt-1">Admin Panel</p>
                        </div>
                        <Avatar className="h-9 w-9 border-2 border-white shadow-md cursor-pointer hover:shadow-lg transition-smooth ring-2 ring-teal-50">
                            <AvatarImage src="https://api.dicebear.com/7.x/shapes/svg?seed=hospital" />
                            <AvatarFallback className="bg-gradient-to-br from-teal-500 to-emerald-600 text-white">CH</AvatarFallback>
                        </Avatar>
                    </div>
                </div>
            </div>
